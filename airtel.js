function detectAndDisplayLogo (phoneNumber){
    ...
    if (phoneNumber.startsWith('0802') || phoneNumber.startsWith('0808') || phoneNumber.startsWith('0708') || phoneNumber.startsWith('0701') || phoneNumber.startsWith('0902') || phoneNumber.startsWith('0907')) {
        imageElement.src = './img/Airtel.png';
        
       
    }else  if (phoneNumber.startsWith('0803') || phoneNumber.startsWith('0806') || phoneNumber.startsWith('0703') || phoneNumber.startsWith('0706') || phoneNumber.startsWith('0814')) {
        alert("Invalid Airtel Number")
        ...
        document.body.style.backgroundImage = "url('./img/BgAirtel.jpg')";
